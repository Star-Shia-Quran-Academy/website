/* ==============================================================
   courses.js – Star Shia Quran Academy (Course Listing)
   ============================================================== */

document.addEventListener('DOMContentLoaded', function () {
    'use strict';

    // ----- Course Data (12 courses) -----
    const courses = [
        {
            id: 'tajweed',
            title: 'Quran Tajweed',
...
`,
        ...
        },
        {
            ...
            fullDesc: `
    <h2>Fun and Engaging Quran Learning for Children</h2>
    <p>
        The <strong>Quran for Kids</strong> course at <strong>Star Shia Quran Academy</strong> is designed to make Quran learning enjoyable and interactive for young learners. As a trusted <strong>online Quran Academy</strong>, we use age-appropriate methods to teach children the Quran with love and understanding.
    </p>
    
    <h3>What Your Child Will Learn</h3>
    <ul>
        <li><strong>Basic Tajweed:</strong> Learn the rules of recitation in a fun and simple way.</li>
        <li><strong>Short Surahs:</strong> Memorize and understand short Surahs from the Quran.</li>
        <li><strong>Basic Islamic Knowledge:</strong> Learn about Allah, the Prophet (PBUH), and the Imams (AS).</li>
        <li><strong>Interactive Activities:</strong> Engage in games, storytelling, and crafts.</li>
        <li><strong>Ethics and Morals:</strong> Develop good character based on Islamic teachings.</li>
    </ul>
    
    <h3>Why Choose This Course?</h3>
    <p>
        At <strong>Star Shia Quran Academy</strong>, our <strong>Shia Quran</strong> teachers are experienced in teaching children. This course offers:
    </p>
    <ul>
        <li><strong>Interactive learning</strong> with fun activities</li>
        <li><strong>Child-friendly teachers</strong> who understand young learners</li>
        <li><strong>Flexible scheduling</strong> to fit your family's routine</li>
        <li><strong>Progress tracking</strong> with regular feedback</li>
    </ul>
    
    <h3>Who Is This Course For?</h3>
    <p>
        This course is designed for children aged 4-12 who want to learn the Quran in a nurturing and engaging environment. Perfect for parents looking for a reliable <strong>Quran Academy for kids</strong>.
    </p>
    
    <h3>Course Structure</h3>
    <ul>
        <li><strong>Duration:</strong> 10 weeks (customizable)</li>
        <li><strong>Session Length:</strong> 30 minutes</li>
        <li><strong>Frequency:</strong> Choose from 1-5 days per week</li>
        <li><strong>Assessment:</strong> Regular fun quizzes and activities</li>
    </ul>
    
    <h3>Enroll Today</h3>
    <p>
        Give your child the gift of Quranic knowledge with <strong>Star Shia Quran Academy</strong>. <a href="contact.html">Contact us</a> for a free trial class and watch your child fall in love with the Quran.
    </p>
`,
...
`,
    ...
    // ----- Render function -----
    function renderCourses(category = 'all', level = 'all') {
        const filtered = courses.filter(c => {
            const catMatch = category === 'all' || c.category === category;
            const levMatch = level === 'all' || c.level === level;
            return catMatch && levMatch;
        });
        ...
        if (filtered.length === 0) {
            grid.innerHTML = `<p class="no-results">No courses match your filters. Try adjusting your selection.</p>`;
            return;
        }
            ...
            html += `
                <div class="course-card">
                    <div class="course-image">
                        <img src="images/courses/${course.image}" alt="${course.title} – Shia Quran Academy" loading="lazy" />
    ...
    categoryFilter.addEventListener('change', function () {
        renderCourses(this.value, levelFilter.value);
    });

    levelFilter.addEventListener('change', function () {
        renderCourses(categoryFilter.value, this.value);
    });

    // ----- Initial render -----
    renderCourses('all', 'all');
});